...
(defun rails-model-layout:keymap (type)
  (let* ((name (capitalize (substring (symbol-name type) 1)))
    ...
    (when type
      ...
      (define-keys map
        ((rails-key "mm")         'rails-model-layout:switch-to-model)
        ((rails-key "mu")         'rails-model-layout:switch-to-unit-test)
        ((rails-key "mi")         'rails-model-layout:switch-to-migration)
        ((rails-key "mc")         'rails-model-layout:switch-to-controller)
        ((rails-key "mx")         'rails-model-layout:switch-to-fixture)
        ((rails-key "mn")         'rails-model-layout:switch-to-mailer)
