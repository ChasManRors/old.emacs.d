...
;; $URL: svn://rubyforge.com/var/svn/emacs-rails/trunk/rails-ui.el $
;; $Id: rails-ui.el 232 2008-08-01 22:42:31Z dimaexe $
...
(define-keys rails-minor-mode-map
  ...
  ((rails-key "\C-c g i") 'rails-nav:goto-migrate)
 ...
 ((rails-key "\C-c s x r") 'rails-script:destroy-resource)
 ((rails-key "\C-c s x o") 'rails-script:destroy-observer)
 ((rails-key "\C-c s x a") 'rails-script:destroy-mailer)
 ((rails-key "\C-c s x p") 'rails-script:destroy-plugin)
 ((rails-key "\C-c s x i") 'rails-script:destroy-migration)
 ((rails-key "\C-c s x s") 'rails-script:destroy-scaffold)
 ((rails-key "\C-c s x m") 'rails-script:destroy-model)
 ((rails-key "\C-c s x c") 'rails-script:destroy-controller)

 ((rails-key "\C-c s g r") 'rails-script:generate-resource)
 ((rails-key "\C-c s g o") 'rails-script:generate-observer)
 ((rails-key "\C-c s g a") 'rails-script:generate-mailer)
 ((rails-key "\C-c s g p") 'rails-script:generate-plugin)
 ((rails-key "\C-c s g i") 'rails-script:generate-migration)
 ((rails-key "\C-c s g s") 'rails-script:generate-scaffold)
 ((rails-key "\C-c s g m") 'rails-script:generate-model)
 ((rails-key "\C-c s g c") 'rails-script:generate-controller)
  ...
  ((rails-key "\C-c f i") 'rails-find:migrate)
  ...
  ((rails-key "\C-c /")        'rails-script:toggle-output-window)
